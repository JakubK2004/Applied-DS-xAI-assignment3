# Shared text preprocessing: loading, cleaning, stemming, and disk caching.
...
def prepare_data(stem: bool = True):
    ...
    # product_uid -> concatenated attribute string
    attr_lookup = (
...
def prepare_data_cached(stem: bool = True):
    """Same as prepare_data() but caches results to disk; auto-invalidates when source CSVs change."""
    source_files = [
        DATA_DIR / "train.csv",
        DATA_DIR / "test.csv",
